...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#4575ab6c#;
   ...
   u00102 : constant Version_32 := 16#ed144d5f#;
   pragma Export (C, u00102, "buttonsB");
   u00103 : constant Version_32 := 16#43863575#;
   ...
   u00344 : constant Version_32 := 16#c05c480c#;
   pragma Export (C, u00344, "system__taskingB");
   u00345 : constant Version_32 := 16#5f56b18c#;
   pragma Export (C, u00345, "system__taskingS");
   u00346 : constant Version_32 := 16#0894e9be#;
   pragma Export (C, u00346, "system__task_primitivesS");
   u00347 : constant Version_32 := 16#c9728a70#;
   pragma Export (C, u00347, "system__os_interfaceB");
   u00348 : constant Version_32 := 16#1d4fb888#;
   pragma Export (C, u00348, "system__os_interfaceS");
   u00349 : constant Version_32 := 16#ff1f7771#;
   pragma Export (C, u00349, "system__linuxS");
   u00350 : constant Version_32 := 16#4474d03e#;
   pragma Export (C, u00350, "system__os_constantsS");
   u00351 : constant Version_32 := 16#60c24add#;
   pragma Export (C, u00351, "system__task_primitives__operationsB");
   u00352 : constant Version_32 := 16#a249a2c5#;
   pragma Export (C, u00352, "system__task_primitives__operationsS");
   u00353 : constant Version_32 := 16#71c5de81#;
   pragma Export (C, u00353, "system__interrupt_managementB");
   u00354 : constant Version_32 := 16#ef0526ae#;
   pragma Export (C, u00354, "system__interrupt_managementS");
   u00355 : constant Version_32 := 16#f65595cf#;
   pragma Export (C, u00355, "system__multiprocessorsB");
   u00356 : constant Version_32 := 16#7e997377#;
   pragma Export (C, u00356, "system__multiprocessorsS");
   u00357 : constant Version_32 := 16#51f2d040#;
   pragma Export (C, u00357, "system__os_primitivesB");
   u00358 : constant Version_32 := 16#41c889f2#;
   pragma Export (C, u00358, "system__os_primitivesS");
   u00359 : constant Version_32 := 16#375a3ef7#;
   pragma Export (C, u00359, "system__task_infoB");
   u00360 : constant Version_32 := 16#d7a1ab61#;
   pragma Export (C, u00360, "system__task_infoS");
   u00361 : constant Version_32 := 16#f0965c7b#;
   pragma Export (C, u00361, "system__tasking__debugB");
   u00362 : constant Version_32 := 16#6502a0c1#;
   pragma Export (C, u00362, "system__tasking__debugS");
   u00363 : constant Version_32 := 16#fd83e873#;
   pragma Export (C, u00363, "system__concat_2B");
   u00364 : constant Version_32 := 16#44953bd4#;
   pragma Export (C, u00364, "system__concat_2S");
